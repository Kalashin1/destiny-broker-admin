              ...
              return (
                <tr className="">
                  ...
                  {user?.isAdmin && transaction.status === "PENDING" && (
                    <td className="whitespace-no-wrap py-4 text-sm font-normal text-gray-500 sm:px-6 lg:table-cell flex flex-col md:flex-row justify-between mr-4 pr-2
                    ">
                      <button
                        className="rounded-full mb-2 md:mb-0 w-8 h-8 bg-green-600 text-white shadow-md mr-4"
                        type="button"
